...
modDatetime: 
title: typora 的 markdown语法
slug: typora 的 markdown语法
featured: false
draft: false
tags:
  - 工具使用
description: typora 的 markdown语法
---
...
输入 `$$`, 然后按“return”键将触发一个接受*Tex / LaTex*源代码的输入区域。以下是一个例子： **V**1×**V**2=∣∣∣∣∣∣**i**∂X∂u∂X∂v**j**∂Y∂u∂Y∂v**k**00∣∣∣∣∣∣V1×V2=|ijk∂X∂u∂Y∂u0∂X∂v∂Y∂v0|
